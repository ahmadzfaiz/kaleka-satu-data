...
class Alamat(models.Model):
    ...
    id = models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True)
    kode_prov = models.CharField(max_length=2, unique=True, verbose_name='Kode Provinsi')
    ...
    kode_kabkot = models.CharField(max_length=4, unique=True, verbose_name='Kode Kabupaten/Kota')
    ...
    kode_kec = models.CharField(max_length=6, unique=True, verbose_name='Kode Kecamatan')
...
class KBJI(models.Model):
    ...
    kode_jabatan = models.DecimalField(max_digits=6, decimal_places=2, verbose_name='Kode Jabatan')
